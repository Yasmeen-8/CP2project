...
public class AddPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        warningLabel.setBackground(new java.awt.Color(210, 43, 43));
        warningLabel.setText("WARNING LABEL");

        lblID.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblID.setForeground(new java.awt.Color(102, 153, 255));
        lblID.setText("ID generated by the default by the system");
    ...
    private void radioEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioEmployeeActionPerformed
        ...
        */
        ...
        if(radioEmployee.isSelected()){ //if statment for the condition of if the Employee radio button is selected
            lblTrainer.setVisible(true);        //then, the components of the Employee will appear, while hiding the related components to Members
